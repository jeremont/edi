...
?>
			 ...
			 <form  style="width: 80%" class="form-horizontal" role="form" action="" method="POST">
			   <div class="form-group"> 
					...
					<div class="input-group margT25"> 
							...
							<input id="login-username" type="text" class="form-control" name="correo" value="<?php if (isset($_SESSION['mail'])) { echo $_SESSION['mail'];} ?>" placeholder="Ingrese su correo"> 
					</div> 
					<br>
  ...
  <br>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php $key; ?>&callback=iniciarMap" >
    </script>
